...
const t=pic.imageList.length-1;
console.log(t);
setInterval(() => {
if(pic.chosenimageindex<pic.imageList.length-1)
{pic.chosenimageindex++;}
else{
  pic.chosenimageindex=0;
}
}, 1000);*/
  ...
  return (
    <div className=' mx-[2rem] text-[15px] text-[white] ml-[1rem] mt-[2rem]'>
   <p>FEATURED & RECOMMENDATIONS</p> 
<div className='mt-3 h-full md:h-[23rem] w-full flex flex-col md:flex-row'>
    <div className='h-full  w-full md:w-[65%] bg-red-400 flex'>
             <img src="https://media.rawg.io/media/games/456/456dea5e1c7e3cd07060c14e96612001.jpg" alt="" className='object-cover w-full' />;
    </div>
     <div className='h-full w-full md:w-[35%] bg-[rgba(5,10,23)] flex flex-col items-center'>
    <p className="text-[28px] mt-2">Son Goku</p>
<div className='px-2 pt-2 w-full h-[19.9rem]'>
<div className='flex pb-1 w-full h-[25%] '>
<img src="https://media.rawg.io/media/games/456/456dea5e1c7e3cd07060c14e96612001.jpg" alt="" className='object-cover w-[50%] pr-1 hover:opacity-[30%]' style={{"cursor":"pointer"}} />
<img src="https://media.rawg.io/media/screenshots/a7c/a7c43871a54bed6573a6a429451564ef.jpg" alt="" className='object-cover w-[50%] pl-1 hover:opacity-[30%]' style={{"cursor":"pointer"}}/>
</div>
<div className='flex w-full h-[25%] pt-1'>
<img src="https://media.rawg.io/media/screenshots/cf4/cf4367daf6a1e33684bf19adb02d16d6.jpg" alt="" className='object-cover w-[50%] pr-1 hover:opacity-[30%]' style={{"cursor":"pointer"}}/>
<img src="https://media.rawg.io/media/screenshots/f95/f9518b1d99210c0cae21fc09e95b4e31.jpg" alt="" className='object-cover w-[50%] pl-1 hover:opacity-[30%]' style={{"cursor":"pointer"}}/>
</div>
<div className='flex flex-col items-center md:items-start'>
 <p className='text-[white] text-[18px] pt-3 ml-1'>Play Now</p>
 <div className='w-[5rem] ml-1 mt-2 rounded-[6px] bg-[green] py-0.5 hover:opacity-[60%]'>
  <p className='text-[13px] text-center'>Discount</p>
 </div>
</div>
</div>
     </div>
